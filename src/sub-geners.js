...
const fillList = (subGeners) => {
    ...
    subGeners.forEach(subGener => {
        ...
        row.textContent = subGener[0];
        description.textContent = subGener[1];
        setCollapsible(row, divDescription)
        anchor.textContent = subGener[0] + ` Books`;
        anchor.setAttribute("href", subGener[2]);
...
const subGeners = [
    ...
    ["Human Development", "Human development fiction predicts future capabilities evolved by mankind, such as enhanced mental or physical abilities.", ""]
];
